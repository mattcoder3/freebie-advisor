            ...
            <a class="game" href=${game.url} target="_blank">
                <div class="game__image-container">
                    <img src=${game.imageUrl} alt="${
											game.title
										} image" class="game__image">
                </div>
                <div class="game__info">
                    <h2 class="game__info-title">${formatTitle(
											game.title,
											22
										)}</h2>
                    <div class="game__info-details">
                        <div class="game__prices">
                            <p class="game__info-price game__info-price_original">USD$${
															game.originalPrice
														}</p>
                            <p class="game__info-price game__info-price_discount">USD$${
															game.discountPrice
														}</p>
                        </div>
